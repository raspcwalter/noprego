...
import {IDirectLoanBase} from "./interfaces/IDirectLoanBase.sol";
import {ILoanData} from "./interfaces/ILoanData.sol";
...
*/ 
    ...
    function renegotiationChecks(
        ILoanData.LoanTerms memory _loan,
        uint32 _loanId,
