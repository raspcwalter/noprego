...
interface ILoanData {
     ...
     * for this loan.
     * @param loanPrincipalAmount - The original sum of money transferred from vault to borrower at the beginning of
     ...
     * @param nftCollateralContract - The address of the the NFT (RWA) collateral contract.
     * @param nftCollateralWrapper - The NFT wrapper of the NFT (RWA) collateral contract.
     ...
     * @param loanDueDate - vencimento do contrato (UTC)
     ...
     * or risk seizure of their nft collateral. 
     * Note if the type of the loan is fixed then this value  is not used and is irrelevant so it should be set to 0. @verify 
     ...
     * earned.
     * @param borrower - tomador do empréstimo / mutuário 
     */
    struct LoanTerms {
